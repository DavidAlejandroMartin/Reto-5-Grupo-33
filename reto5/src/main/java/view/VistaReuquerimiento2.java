 ...
 * @author alejo
 */
public class VistaReuquerimiento2 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaReuquerimiento2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaReuquerimiento2().setVisible(true);
            }
        });
    }
